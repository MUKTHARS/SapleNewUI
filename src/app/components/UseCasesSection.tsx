      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          {/* <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-sky-200/50 shadow-sm mb-6">
            ...
            <span className="text-sm font-medium text-sky-800">Agentic Copilot</span>
          </div> */}
          <section className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Empower Your Agents with Superpowers
          </section>
        ...
        {/* Use Cases Grid - Glass cards like KeyCapabilities */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              icon: <Zap className="w-6 h-6" />,
              title: "Supercharge Agent Efficiency",
              description: "Boost workforce efficiency with AI-driven real-time coaching and automated post-call summaries.",
            ...
            },
            {
              ...
              description: "Ensure agents can instantly tap into essential knowledge and resources with ease.",
            ...
            },
            {
              ...
              description: "Empower teams to serve customers in any language with real-time AI translation.",
            ...
            },
            {
              ...
              description: "Provide fast, accurate responses – eliminating the need for customers to repeat themselves.",
