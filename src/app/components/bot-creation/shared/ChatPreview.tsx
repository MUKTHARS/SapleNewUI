...
import { Bot, User, Mic, MessageSquare, Volume2, MessageCircle } from 'lucide-react';
...
export function ChatPreview({ formData }: ChatPreviewProps) {
  const getMediaTypeIcon = () => {
    switch (formData.media_type) {
      ...
      case 'both': return <MessageCircle className="w-4 h-4" />;
      ...
      <div className="bg-white rounded-xl border border-gray-300 p-4 max-w-md mx-auto shadow-sm">
        ...
        <div className="mt-4 pt-3 border-t border-gray-200">
          <div className="flex space-x-2">
            ...
            {(formData.media_type === 'text' || formData.media_type === 'both') && (
              <button
